	...
	public:	
		...
		void call_message_movement() {
			...
			if (data_movement_ == _controller_data_pON2KJ19UK0H9) {
				value.linear.x = 0.3;
			}
		...
		void call_message_halt() {
			...
			if (data_halt_ == _controller_data_pI73L4X7PIEKS) {
				value.linear.x = 0.0;
			}
		...
		void call_message_turn_left() {
			...
			if (data_turn_left_ == _controller_data_pZB9R5LE70IH9) {
				value.data = 90;
			}
		...
		void call_message_turn_right() {
			...
			if (data_turn_right_ == _controller_data_pR7WORKRJVGLR) {
				value.data = 90;
			}
	...
	private:
		...
		void tick() {
			int nOfDataEvents = 4;
			      controller_Event_ data_events[4] = { data_movement_c_pAA5SQ9I1FK3M_,data_halt_c_p1RWY554RXZ40_,data_turn_left_c_pXPJUVY1WPWX3_,data_turn_right_c_pTSZKXXWXIZS1_ };

...
const char *controller_event_names[] = {
    ...
    "data_move_forward.c_pPR7XVQ7Z9QUV", /**< Event data_move_forward.c_pPR7XVQ7Z9QUV. */
    "data_move_forward.c_pPPIOGABJ1ZUF", /**< Event data_move_forward.c_pPPIOGABJ1ZUF. */
    "data_move_forward.c_pYZS8TWNRJCQO", /**< Event data_move_forward.c_pYZS8TWNRJCQO. */
...
/**
 * Execute code for event "data_move_forward.c_pPPIOGABJ1ZUF".
 *
 * @return Whether the event was performed.
 */
static BoolType execEvent1(void) {
    BoolType guard = ((((data_move_forward_) == (_controller_none)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_free)))) || (((data_move_forward_) == (_controller_data_pH6YGADB3NGHU)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_free))))) || ((((data_move_forward_) == (_controller_data_pD87P7RETTQ3A)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_free)))) || (((data_move_forward_) == (_controller_data_pG36J71ITNOBN)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_free)))));
    if (!guard) return FALSE;

    #if EVENT_OUTPUT
        controller_InfoEvent(data_move_forward_c_pPPIOGABJ1ZUF_, TRUE);
    #endif

    if (((data_move_forward_) == (_controller_none)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_free)))) {
        data_move_forward_ = _controller_data_pD87P7RETTQ3A;
    } else if (((data_move_forward_) == (_controller_data_pH6YGADB3NGHU)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_free)))) {
        data_move_forward_ = _controller_data_pD87P7RETTQ3A;
    } else if (((data_move_forward_) == (_controller_data_pD87P7RETTQ3A)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_free)))) {
        data_move_forward_ = _controller_data_pD87P7RETTQ3A;
    } else if (((data_move_forward_) == (_controller_data_pG36J71ITNOBN)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_free)))) {
        data_move_forward_ = _controller_data_pD87P7RETTQ3A;
    }

    #if EVENT_OUTPUT
        controller_InfoEvent(data_move_forward_c_pPPIOGABJ1ZUF_, FALSE);
    #endif
    return TRUE;
}

/**
 * Execute code for event "data_move_forward.c_pPR7XVQ7Z9QUV".
 *
 * @return Whether the event was performed.
 */
static BoolType execEvent2(void) {
    BoolType guard = ((((data_move_forward_) == (_controller_none)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_person)))) || (((data_move_forward_) == (_controller_data_pH6YGADB3NGHU)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_person))))) || ((((data_move_forward_) == (_controller_data_pD87P7RETTQ3A)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_person)))) || (((data_move_forward_) == (_controller_data_pG36J71ITNOBN)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_person)))));
    if (!guard) return FALSE;

    #if EVENT_OUTPUT
        controller_InfoEvent(data_move_forward_c_pPR7XVQ7Z9QUV_, TRUE);
    #endif

    if (((data_move_forward_) == (_controller_none)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_person)))) {
        data_move_forward_ = _controller_data_pH6YGADB3NGHU;
    } else if (((data_move_forward_) == (_controller_data_pH6YGADB3NGHU)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_person)))) {
        data_move_forward_ = _controller_data_pH6YGADB3NGHU;
    } else if (((data_move_forward_) == (_controller_data_pD87P7RETTQ3A)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_person)))) {
        data_move_forward_ = _controller_data_pH6YGADB3NGHU;
    } else if (((data_move_forward_) == (_controller_data_pG36J71ITNOBN)) && (((component_YoloxDetection_) == (_controller_detected)) && ((component_Scanner_v_distance_) == (_controller_person)))) {
        data_move_forward_ = _controller_data_pH6YGADB3NGHU;
    }

    #if EVENT_OUTPUT
        controller_InfoEvent(data_move_forward_c_pPR7XVQ7Z9QUV_, FALSE);
    #endif
    return TRUE;
}

/**
 * Execute code for event "data_move_forward.c_pYZS8TWNRJCQO".
 *
 * @return Whether the event was performed.
 */
static BoolType execEvent3(void) {
    BoolType guard = ((((data_move_forward_) == (_controller_none)) && ((component_YoloxDetection_) == (_controller_initializing))) || (((data_move_forward_) == (_controller_data_pH6YGADB3NGHU)) && ((component_YoloxDetection_) == (_controller_initializing)))) || ((((data_move_forward_) == (_controller_data_pD87P7RETTQ3A)) && ((component_YoloxDetection_) == (_controller_initializing))) || (((data_move_forward_) == (_controller_data_pG36J71ITNOBN)) && ((component_YoloxDetection_) == (_controller_initializing))));
    if (!guard) return FALSE;

    #if EVENT_OUTPUT
        controller_InfoEvent(data_move_forward_c_pYZS8TWNRJCQO_, TRUE);
    #endif

    if (((data_move_forward_) == (_controller_none)) && ((component_YoloxDetection_) == (_controller_initializing))) {
        data_move_forward_ = _controller_data_pG36J71ITNOBN;
    } else if (((data_move_forward_) == (_controller_data_pH6YGADB3NGHU)) && ((component_YoloxDetection_) == (_controller_initializing))) {
        data_move_forward_ = _controller_data_pG36J71ITNOBN;
    } else if (((data_move_forward_) == (_controller_data_pD87P7RETTQ3A)) && ((component_YoloxDetection_) == (_controller_initializing))) {
        data_move_forward_ = _controller_data_pG36J71ITNOBN;
    } else if (((data_move_forward_) == (_controller_data_pG36J71ITNOBN)) && ((component_YoloxDetection_) == (_controller_initializing))) {
        data_move_forward_ = _controller_data_pG36J71ITNOBN;
    }

    #if EVENT_OUTPUT
        controller_InfoEvent(data_move_forward_c_pYZS8TWNRJCQO_, FALSE);
    #endif
    return TRUE;
}
...
static void PerformEvents(void) {
    ...
    for (;;) {
        ...
        if (execEvent1()) continue;  /* (Try to) perform event "data_move_forward.c_pPPIOGABJ1ZUF". */
        if (execEvent2()) continue;  /* (Try to) perform event "data_move_forward.c_pPR7XVQ7Z9QUV". */
        if (execEvent3()) continue;  /* (Try to) perform event "data_move_forward.c_pYZS8TWNRJCQO". */
        if (execEvent6()) continue;  /* (Try to) perform event "message_halt.c_trigger". */
        if (execEvent7()) continue;  /* (Try to) perform event "message_move_forward.c_trigger". */
...
BoolType controller_EnginePerformEvent(controller_Event_ event) {
    switch (event) {
        case data_halt_c_p9V7373FIS9TO_:
            return execEvent0();
        case data_move_forward_c_pPPIOGABJ1ZUF_:
            return execEvent1();
        case data_move_forward_c_pPR7XVQ7Z9QUV_:
            return execEvent2();
        case data_move_forward_c_pYZS8TWNRJCQO_:
            return execEvent3();

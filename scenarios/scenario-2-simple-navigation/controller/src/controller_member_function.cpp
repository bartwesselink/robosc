	...
	public:	
		...
		void call_action_navigate() {
			...
			if (data_navigate_ == _controller_data_pT4NY0XMH1T6O) {
	...
	private:
		...
		void tick() {
			int nOfDataEvents = 1;
			      controller_Event_ data_events[1] = { data_navigate_c_pXUMOI80JMDUU_ };

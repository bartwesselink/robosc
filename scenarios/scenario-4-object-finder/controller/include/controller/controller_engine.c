...
const char *controller_event_names[] = {
    ...
    "component_ObjectDetector.c_pCY9OPG8O7KCK", /**< Event component_ObjectDetector.c_pCY9OPG8O7KCK. */
...
/**
 * Execute code for event "component_ObjectDetector.c_pCY9OPG8O7KCK".
 *
...
static BoolType execEvent0(void) {
    ...
    #if EVENT_OUTPUT
        controller_InfoEvent(component_ObjectDetector_c_pCY9OPG8O7KCK_, TRUE);
    #endif

    component_ObjectDetector_ = _controller_object_found;

    #if EVENT_OUTPUT
        controller_InfoEvent(component_ObjectDetector_c_pCY9OPG8O7KCK_, FALSE);
    #endif
    return TRUE;
}

/**
 * Execute code for event "component_ObjectDetector.c_pZIDHF63YTIV8".
 *
 * @return Whether the event was performed.
 */
static BoolType execEvent1(void) {
    ...
    #if EVENT_OUTPUT
        controller_InfoEvent(component_ObjectDetector_c_pZIDHF63YTIV8_, TRUE);
    #endif

    component_ObjectDetector_ = _controller_no_object;

    #if EVENT_OUTPUT
        controller_InfoEvent(component_ObjectDetector_c_pZIDHF63YTIV8_, FALSE);
    #endif
    return TRUE;
}
...
BoolType controller_EnginePerformEvent(controller_Event_ event) {
    switch (event) {
        case component_ObjectDetector_c_pCY9OPG8O7KCK_:
            return execEvent0();

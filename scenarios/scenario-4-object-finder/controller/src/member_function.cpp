...
public:	
	...
	void call_message_move() {
		...
		if (data_move_ == _controller_data_p09VPMA0YF0LE) {
			value.linear.x = 0.5;
			value.angular.z = 0.0;
		}
	...
	void call_message_halt() {
		...
		if (data_halt_ == _controller_data_p6WJ9Q5EL6S92) {
			value.linear.x = 0.0;
			value.angular.z = 0.0;
		}
...
private:
	...
	void tick() {
		int nOfDataEvents = 2;
		      controller_Event_ data_events[2] = { data_move_c_p1HIPH7IC9U78_,data_halt_c_p6YHW6KZL68HQ_ };
		...
		int nOfControllableEvents = 6;
		      controller_Event_ controllable_events[6] = { component_ObjectDetector_c_pFDUHMFYFEZ1C_,component_ObjectDetector_c_pIT6QHH818CVU_,message_rotate_left_c_trigger_,message_rotate_right_c_trigger_,message_move_c_trigger_,message_halt_c_trigger_ };
